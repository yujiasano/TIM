...
ActiveRecord::Schema.define(version: 20200513013339) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.integer  "like_id"
    t.index ["like_id"], name: "index_answers_on_like_id", using: :btree
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["answer_id"], name: "index_likes_on_answer_id", using: :btree
